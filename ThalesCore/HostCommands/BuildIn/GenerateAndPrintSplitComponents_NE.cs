...
{
    [ThalesCommandCode("NE", "NF", "", "Generate and print a key as split components.")]
    public class GenerateAndPrintSplitComponents_NE : AHostCommand
    {
        public GenerateAndPrintSplitComponents_NE()
        {
            ReadXMLDefinitions();
        }
