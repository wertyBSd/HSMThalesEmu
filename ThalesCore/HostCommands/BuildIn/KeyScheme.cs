...
{
    /// <summary>
    /// Helper class used to load the XML definition fragment for a key scheme.
    /// This is not a runnable host command; it exists so the XML parser can
    /// include the `KeyScheme.xml` field definition where needed.
    /// Do not assign a ThalesCommandCode attribute to this class.
    /// </summary>
    public class KeyScheme : AHostCommand
    {
        public KeyScheme()
        {
            ReadXMLDefinitions();
