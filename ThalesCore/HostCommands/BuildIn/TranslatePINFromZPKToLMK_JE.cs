...
{
    [ThalesCommandCode("JE", "JF", "", "Translates a PIN from ZPK to LMK encryption.")]
    public class TranslatePINFromZPKToLMK_JE : AHostCommand
    {
        public TranslatePINFromZPKToLMK_JE()
        {
            ReadXMLDefinitions();
        }
        ...
        public override MessageResponse ConstructResponse()
        {
            ...
            try
            {
                ...
                string decBlock = ThalesCore.Cryptography.TripleDES.TripleDESDecrypt(new ThalesCore.Cryptography.HexKey(zpk), pinBlock);
