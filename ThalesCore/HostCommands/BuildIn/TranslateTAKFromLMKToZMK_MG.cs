...
{
    [ThalesCommandCode("MG", "MH", "", "Translates a TAK from encryption under the LMK to encryption under a ZMK.")]
    public class TranslateTAKFromLMKToZMK_MG : AHostCommand
    {
        public TranslateTAKFromLMKToZMK_MG()
        {
            ReadXMLDefinitions();
        }
