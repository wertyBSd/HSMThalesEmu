...
{
    [ThalesCommandCode("MI", "MJ", "", "Translates a TAK from encryption under a ZMK to encryption under LMK.")]
    public class TranslateTAKFromZMKToLMK_MI : AHostCommand
    {
        public TranslateTAKFromZMKToLMK_MI()
        {
            ReadXMLDefinitions();
        }
