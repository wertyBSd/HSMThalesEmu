...
{
    [ThalesCommandCode("AE", "AF", "", "Translates a TMK, TPK or PVK from LMK to TMP, TPK or PVK encryption.")]
    public class TranslateTMKTPKPVKFromLMKToTMKTPKPVK_AE : AHostCommand
    {
        public TranslateTMKTPKPVKFromLMKToTMKTPKPVK_AE()
        {
            ReadXMLDefinitions();
        }
