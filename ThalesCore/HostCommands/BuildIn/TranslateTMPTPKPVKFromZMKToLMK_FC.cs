...
{
    [ThalesCommandCode("FC", "FD", "", "Translates a TMK, TPK or PVK from encryption under a ZMK to encryption under LMK.")]
    public class TranslateTMPTPKPVKFromZMKToLMK_FC : AHostCommand
    {
        public TranslateTMPTPKPVKFromZMKToLMK_FC()
        {
            ReadXMLDefinitions();
        }
