...
{
    [ThalesCommandCode("FK", "FL", "", "Translates a ZEK or ZAK from encryption under a ZMK to encryption under LMK.")]
    public class TranslateZEKORZAKFromZMKToLMK_FK : AHostCommand
    {
        public TranslateZEKORZAKFromZMKToLMK_FK()
        {
            ReadXMLDefinitions();
        }
