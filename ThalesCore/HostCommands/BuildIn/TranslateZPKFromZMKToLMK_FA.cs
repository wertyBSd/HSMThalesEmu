...
{
    [ThalesCommandCode("FA", "FB", "", "Translates a ZPK from encryption under a ZMK to encryption under LMK.")]
    public class TranslateZPKFromZMKToLMK_FA : AHostCommand
    {
        public TranslateZPKFromZMKToLMK_FA()
        {
            ReadXMLDefinitions();
        }
